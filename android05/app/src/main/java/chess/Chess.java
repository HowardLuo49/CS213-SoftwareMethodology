...
public class Chess {
	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			while(!validMove(fileStart, rankStart, fileEnd, rankEnd, whiteTurn, board)) {
				System.out.println("Illegal move, try again. ");
				if(whiteTurn)
					System.out.println("White's move: ");
				else
	 ...
	 * @see Piece#legal
	 */
	public static boolean validMove(int fileStart, int rankStart, int fileEnd, int rankEnd, boolean whiteTurn, Piece[][] inputBoard) {
